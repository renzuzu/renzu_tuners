...
config.engineupgrades = {
	-- ULTIMATE
	{category = 'ultimate', state = 'engine_oil', item = 'ultimate_oil', label = 'Ultimate Oil', handling = {'fInitialDriveMaxFlatVel'}, add = 1.15, affects = 'Top Speed', cost = 25000},
	{category = 'ultimate', state = 'engine_sparkplug', item = 'ultimate_sparkplug', label = 'Ultimate Spark Plug', stat = {ignition = 3.2}, handling = {'fDriveInertia'}, add = 1.3, affects = 'Torque', cost = 25000},
	{category = 'ultimate', state = 'engine_gasket', item = 'ultimate_gasket', label = 'Ultimate Head Gasket', handling = {'fDriveInertia'}, add = 1.2, affects = 'Torque', cost = 25000},
	 {category = 'ultimate', state = 'engine_airfilter', item = 'ultimate_airfilter', label = 'Ultimate Air Filter', handling = {'fInitialDriveForce'}, add =1.2, affects = 'Horsepower', cost = 25000},
	{category = 'ultimate', state = 'engine_fuelinjector', item = 'ultimate_fuelinjector', label = 'Ultimate Fuel Injectors', stat = {fuelpressure = 43.2}, handling = {'fInitialDriveForce'}, add = 1.2, affects = 'Horsepower', cost = 25000},
	{category = 'ultimate', state = 'engine_pistons', item = 'ultimate_pistons', label = 'Ultimate Pistons' , stat = {compression = 16.0, fuelpressure = -16.0, ignition = 8.0}, handling = {'fInitialDriveMaxFlatVel'}, add = 1.2, affects = 'Top Speed', mod = {index = 11, add = 1}, cost = 25000},
	{category = 'ultimate', state = 'engine_connectingrods', item = 'ultimate_connectingrods', label = 'Ultimate Connecting Rods' , handling = {'fInitialDriveForce'}, add = 1.2, affects = 'Top Speed', cost = 25000},
	{category = 'ultimate', state = 'engine_valves', item = 'ultimate_valves', label = 'Ultimate Valves', stat = {compression = 1.6, fuelpressure = -1.6}, handling = {'fInitialDriveForce'}, add = 1.2, affects = 'Horsepower', cost = 25000},
	{category = 'ultimate', state = 'engine_block', item = 'ultimate_block', label = 'Ultimate Block', stat = {compression = 16.0, fuelpressure = -8.0, ignition = 8.0}, handling = {'fInitialDriveMaxFlatVel'}, add = 1.3, affects = 'Top Speed', mod = {index = 11, add = 1}, cost = 25000},
	{category = 'ultimate', state = 'engine_crankshaft', item = 'ultimate_crankshaft', label = 'Ultimate CranfkShaft',  stat = {ignition = 8.0}, handling = {'fDriveInertia'}, add = 1.2, affects = 'Torque', mod = {index = 11, add = 1}, cost = 25000},
	{category = 'ultimate', state = 'transmition_clutch', item = 'ultimate_clutch', label = 'Ultimate Transmission Clutch', handling = {'fClutchChangeRateScaleUpShift'}, add = 1.4, affects = 'Down Shifting', mod = {index = 13, add = 1}, cost = 25000},
	{category = 'ultimate', state = 'engine_flywheel', item = 'ultimate_flywheel', label = 'Ultimate FlyWheel', handling = {'fClutchChangeRateScaleDownShift'}, add = 1.3, affects = 'Up Shifting', mod = {index = 13, add = 1}, cost = 25000},
	{category = 'ultimate', state = 'engine_camshaft', item = 'ultimate_camshaft', label = 'Ultimate Camshaft',stat = {duration = 48.0, compression = 16.0, fuelpressure = -16.0, ignition = 16.0}, handling = {'fInitialDriveMaxFlatVel'}, add = 1.3, affects = 'Top Speed', mod = {index = 11, add = 1}, cost = 25000},
	{category = 'ultimate', state = 'oem_brakes', item = 'ultimate_brakes', label = 'Ultimate Brakes', handling = {'fBrakeForce','fHandBrakeForce'}, add = 6.4, affects = 'Brake Power', mod = {index = 12, add = 3}, cost = 25000},
	{category = 'ultimate', state = 'oem_suspension', item = 'ultimate_suspension', label = 'Ultimate Suspension', handling = {'fSuspensionForce','fSuspensionCompDamp','fSuspensionReboundDamp','fSuspensionUpperLimit','fSuspensionLowerLimit','fSuspensionRaise','fSuspensionBiasFront','fAntiRollBarForce','fAntiRollBarBiasFront','fRollCentreHeightFront','fRollCentreHeightRear'}, add = 1.6, affects = 'Suspension', mod = {index = 15, add = 4}, cost = 25000},
	{category = 'ultimate', state = 'oem_gearbox', item = 'ultimate_gearbox', label = 'Ultimate Gearbox', handling = {'nInitialDriveGears','fDriveInertia','fClutchChangeRateScaleUpShift','fClutchChangeRateScaleDownShift'}, add = 1.7, affects = 'Acceleration', mod = {index = 13, add = 1}, cost = 25000},
	-- RACING
	{category = 'racing', state = 'engine_oil', item = 'racing_oil', label = 'Racing Oil', handling = {'fInitialDriveMaxFlatVel'}, add = 1.1, affects = 'Top Speed', cost = 25000},
	{category = 'racing', state = 'engine_sparkplug', item = 'racing_sparkplug', label = 'Racing Spark Plug', stat = {ignition = 1.6}, handling = {'fDriveInertia'}, add = 1.2, affects = 'Torque', cost = 25000},
	{category = 'racing', state = 'engine_gasket', item = 'racing_gasket', label = 'Racing Head Gasket', handling = {'fDriveInertia'}, add = 1.1, affects = 'Torque', cost = 25000},
	 {category = 'racing', state = 'engine_airfilter', item = 'racing_airfilter', label = 'Racing Air Filter', handling = {'fInitialDriveForce'}, add = 1.1, affects = 'Horsepower', cost = 25000},
	{category = 'racing', state = 'engine_fuelinjector', item = 'racing_fuelinjector', label = 'Racing Fuel Injectors', stat = {fuelpressure = 21.6}, handling = {'fInitialDriveForce'}, add = 1.1, affects = 'Horsepower', cost = 25000},
	{category = 'racing', state = 'engine_pistons', item = 'racing_pistons', label = 'Racing Pistons', stat = {compression = 8.0, fuelpressure = -8.0, ignition = 4.0}, handling = {'fInitialDriveMaxFlatVel'}, add = 1.1, affects = 'Top Speed', mod = {index = 11, add = 1}, cost = 25000},
	{category = 'racing', state = 'engine_connectingrods', item = 'racing_connectingrods', label = 'Racing Connecting Rods' , handling = {'fInitialDriveForce'}, add = 1.1, affects = 'Top Speed', cost = 25000},
	{category = 'racing', state = 'engine_valves', item = 'racing_valves', label = 'Racing Valves', stat = {compression = 0.8, fuelpressure = -0.8}, handling = {'fInitialDriveForce'}, add = 1.1, affects = 'Horsepower', cost = 25000},
	{category = 'racing', state = 'engine_block', item = 'racing_block', label = 'Racing Block', stat = {compression = 8.0, fuelpressure = -4.0, ignition = 4.0}, handling = {'fInitialDriveMaxFlatVel'}, add = 1.2, affects = 'Top Speed', mod = {index = 11, add = 1}, cost = 25000},
	{category = 'racing', state = 'engine_crankshaft', item = 'racing_crankshaft', label = 'Racing CranfkShaft', stat = {ignition = 4.0}, handling = {'fDriveInertia'}, add = 1.1, affects = 'Torque', mod = {index = 11, add = 1}, cost = 25000},
	{category = 'racing', state = 'transmition_clutch', item = 'racing_clutch', label = 'Racing Transmission Clutch', handling = {'fClutchChangeRateScaleUpShift'}, add = 1.3, affects = 'Down Shifting', mod = {index = 13, add = 1}, cost = 25000},
	{category = 'racing', state = 'engine_flywheel', item = 'racing_flywheel', label = 'Racing FlyWheel', handling = {'fClutchChangeRateScaleDownShift'}, add = 1.2, affects = 'Up Shifting', mod = {index = 13, add = 1}, cost = 25000},
	{category = 'racing', state = 'engine_camshaft', item = 'racing_camshaft', label = 'Racing Camshaft',stat = {duration = 26.0, compression = 8.0, fuelpressure = -8.0, ignition = 8.0}, handling = {'fInitialDriveMaxFlatVel'}, add = 1.2, affects = 'Top Speed', mod = {index = 11, add = 1}, cost = 25000},
	{category = 'racing', state = 'oem_brakes', item = 'racing_brakes', label = 'Racing Brakes', handling = {'fBrakeForce','fHandBrakeForce'}, add = 4.4, affects = 'Brake Power', mod = {index = 12, add = 3}, cost = 25000},
	{category = 'racing', state = 'oem_suspension', item = 'racing_suspension', label = 'Racing Suspension', handling = {'fSuspensionForce','fSuspensionCompDamp','fSuspensionReboundDamp','fSuspensionUpperLimit','fSuspensionLowerLimit','fSuspensionRaise','fSuspensionBiasFront','fAntiRollBarForce','fAntiRollBarBiasFront','fRollCentreHeightFront','fRollCentreHeightRear'}, add = 1.4, affects = 'Suspension', mod = {index = 15, add = 4}, cost = 25000},
	{category = 'racing', state = 'oem_gearbox', item = 'racing_gearbox', label = 'Racing Gearbox', handling = {'nInitialDriveGears','fDriveInertia','fClutchChangeRateScaleUpShift','fClutchChangeRateScaleDownShift'}, add = 1.5, affects = 'Acceleration', mod = {index = 13, add = 1}, cost = 25000},
	-- PRO
	{category = 'pro', state = 'engine_oil', item = 'pro_oil', label = 'Pro Oil', handling = {'fInitialDriveMaxFlatVel'}, add = 1.07, affects = 'Top Speed', cost = 25000},
	{category = 'pro', state = 'engine_sparkplug', item = 'pro_sparkplug', label = 'Pro Spark Plug',stat = {ignition = 0.8}, handling = {'fDriveInertia'}, add = 1.12, affects = 'Torque', cost = 25000},
	{category = 'pro', state = 'engine_gasket', item = 'pro_gasket', label = 'Pro Head Gasket', handling = {'fDriveInertia'}, add = 1.07, affects = 'Torque', cost = 25000},
	 {category = 'pro', state = 'engine_airfilter', item = 'pro_airfilter', label = 'Pro Air Filter', handling = {'fInitialDriveForce'}, add =1.07, affects = 'Horsepower', cost = 25000},
	{category = 'pro', state = 'engine_fuelinjector', item = 'pro_fuelinjector', label = 'Pro Fuel Injectors',stat = {fuelpressure = 12.0},  handling = {'fInitialDriveForce'}, add = 1.07, affects = 'Horsepower', cost = 25000},
	{category = 'pro', state = 'engine_pistons', item = 'pro_pistons', label = 'Pro Pistons' , stat = {compression = 4.0, fuelpressure = -4.0, ignition = 2.0}, handling = {'fInitialDriveMaxFlatVel'}, add = 1.07, affects = 'Top Speed', mod = {index = 11, add = 1}, cost = 25000},
	{category = 'pro', state = 'engine_connectingrods', item = 'pro_connectingrods', label = 'Pro Connecting Rods' , handling = {'fInitialDriveForce'}, add = 1.07, affects = 'Top Speed', cost = 25000},
	{category = 'pro', state = 'engine_valves', item = 'pro_valves', label = 'Pro Valves', stat = {compression = 0.4, fuelpressure = -0.4}, handling = {'fInitialDriveForce'}, add = 1.07, affects = 'Horsepower', cost = 25000},
	{category = 'pro', state = 'engine_block', item = 'pro_block', label = 'Pro Block', stat = {compression = 4.0, fuelpressure = -2.0, ignition = 2.0}, handling = {'fInitialDriveMaxFlatVel'}, add = 1.12, affects = 'Top Speed', mod = {index = 11, add = 1}, cost = 25000},
	{category = 'pro', state = 'engine_crankshaft', item = 'pro_crankshaft', label = 'Pro CranfkShaft', stat = {ignition = 2.0}, handling = {'fDriveInertia'}, add = 1.07, affects = 'Torque', mod = {index = 11, add = 1}, cost = 25000},
	{category = 'pro', state = 'transmition_clutch', item = 'pro_clutch', label = 'Pro Transmission Clutch', handling = {'fClutchChangeRateScaleUpShift'}, add = 1.12, affects = 'Down Shifting', mod = {index = 13, add = 1}, cost = 25000},
	{category = 'pro', state = 'engine_flywheel', item = 'pro_flywheel', label = 'Pro FlyWheel', handling = {'fClutchChangeRateScaleDownShift'}, add = 1.07, affects = 'Up Shifting', mod = {index = 13, add = 1}, cost = 25000},
	{category = 'pro', state = 'engine_camshaft', item = 'pro_camshaft', label = 'Pro Camshaft',stat = {duration = 12.6,compression = 4.0, fuelpressure = -4.0, ignition = 4.0}, handling = {'fInitialDriveMaxFlatVel'}, add = 1.12, affects = 'Top Speed', mod = {index = 11, add = 1}, cost = 25000},
	{category = 'pro', state = 'oem_brakes', item = 'pro_brakes', label = 'Pro Brakes', handling = {'fBrakeForce','fHandBrakeForce'}, add = 3.4, affects = 'Brake Power', mod = {index = 12, add = 3}, cost = 25000},
	...
	{category = 'elite', state = 'engine_valves', item = 'elite_valves', label = 'Elite Valves',stat = {compression = 0.2, fuelpressure = -0.2}, handling = {'fInitialDriveForce'}, add = 1.03, affects = 'Horsepower', cost = 25000},
	{category = 'elite', state = 'engine_block', item = 'elite_block', label = 'Elite Block',stat = {compression = 2.0, fuelpressure = -1.0, ignition = 1.0}, handling = {'fInitialDriveMaxFlatVel'}, add = 1.05, affects = 'Top Speed', mod = {index = 11, add = 1}, cost = 25000},
	{category = 'elite', state = 'engine_crankshaft', item = 'elite_crankshaft', label = 'Elite CranfkShaft',stat = {ignition = 1.0}, handling = {'fDriveInertia'}, add = 1.03, affects = 'Torque', mod = {index = 11, add = 1}, cost = 25000},
	{category = 'elite', state = 'transmition_clutch', item = 'elite_clutch', label = 'Elite Transmission Clutch', handling = {'fClutchChangeRateScaleUpShift'}, add = 1.1, affects = 'Down Shifting', mod = {index = 13, add = 1}, cost = 25000},
	{category = 'elite', state = 'engine_flywheel', item = 'elite_flywheel', label = 'Elite FlyWheel', handling = {'fClutchChangeRateScaleDownShift'}, add = 1.03, affects = 'Up Shifting', mod = {index = 13, add = 1}, cost = 25000},
	{category = 'elite', state = 'engine_camshaft', item = 'elite_camshaft', label = 'Elite Camshaft',stat = {duration = 6.3, compression = 2.0, fuelpressure = -2.0, ignition = 2.0}, handling = {'fInitialDriveMaxFlatVel'}, add = 1.05, affects = 'Top Speed', mod = {index = 11, add = 1}, cost = 25000},
	{category = 'elite', state = 'oem_brakes', item = 'elite_brakes', label = 'Elite Brakes', handling = {'fBrakeForce','fHandBrakeForce'}, add = 2.4, affects = 'Brake Power', mod = {index = 12, add = 3}, cost = 25000},
	{category = 'elite', state = 'oem_suspension', item = 'elite_suspension', label = 'Elite Suspension', handling = {'fSuspensionForce','fSuspensionCompDamp','fSuspensionReboundDamp','fSuspensionUpperLimit','fSuspensionLowerLimit','fSuspensionRaise','fSuspensionBiasFront','fAntiRollBarForce','fAntiRollBarBiasFront','fRollCentreHeightFront','fRollCentreHeightRear'}, add = 1.1, affects = 'Suspension', mod = {index = 15, add = 4}, cost = 25000},
	{category = 'elite', state = 'oem_gearbox', item = 'elite_gearbox', label = 'Elite Gearbox', handling = {'nInitialDriveGears','fDriveInertia','fClutchChangeRateScaleUpShift','fClutchChangeRateScaleDownShift'}, add = 1.1, affects = 'Acceleration', mod = {index = 13, add = 1}, cost = 25000},
}
